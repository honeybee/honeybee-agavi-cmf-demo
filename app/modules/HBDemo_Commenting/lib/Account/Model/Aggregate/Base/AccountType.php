...
namespace HBDemo\Commenting\Account\Model\Aggregate\Base;

use Trellis\Common\Options;
use Workflux\StateMachine\StateMachineInterface;
use HBDemo\Commenting\Account\Model\Aggregate\Base;
use Honeybee\Model\Aggregate\AggregateRootType;

/**
 * Serves as the base class to the 'Account' type skeleton.
 */
abstract class AccountType extends AggregateRootType
{
    /**
            ...
            [
                ...
                new \Trellis\Runtime\Attribute\EntityReferenceList\EntityReferenceListAttribute(
                    ...
                    array(
                        ...
                        'max_count' => 1,
                        'entity_types' => array(
                            '\\HBDemo\\Commenting\\Account\\Model\\Aggregate\\Reference\\OwnerType',
                        ),
                    )
                ),
            ],
    ...
    {
        return '\\HBDemo\\Commenting\\Account\\Model\\Aggregate\\Account';
    }
}
