...
namespace HBDemo\Commenting\Comment\Projection\EventHandler;
...
use HBDemo\Commenting\Topic\Model\Task\ProceedTopicWorkflow\TopicWorkflowProceededEvent;
use HBDemo\Commenting\Owner\Model\Task\ProceedOwnerWorkflow\OwnerWorkflowProceededEvent;
use HBDemo\Commenting\Comment\Model\Task\ProceedCommentWorkflow\ProceedCommentWorkflowCommand;

class CommentProjectionUpdater extends RelationProjectionUpdater
{
    ...
    public function handleEvent(EventInterface $event)
    {
        ...
        if (($event instanceof OwnerWorkflowProceededEvent
            || $event instanceof TopicWorkflowProceededEvent)
            ...
            foreach ($affected_entities as $affected_entity) {
                $command = new ProceedCommentWorkflowCommand(
                    [
