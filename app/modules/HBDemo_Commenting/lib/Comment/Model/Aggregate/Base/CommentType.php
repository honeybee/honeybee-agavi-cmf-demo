...
use HBDemo\Commenting\Comment\Model\Aggregate\Base;
use Honeybee\Model\Aggregate\AggregateRootType;

/**
 * Serves as the base class to the 'Comment' type skeleton.
 */
abstract class CommentType extends AggregateRootType
{
    /**
            ...
            [
                ...
                new \Trellis\Runtime\Attribute\EntityReferenceList\EntityReferenceListAttribute(
                    ...
                    array(
                        ...
                        'max_count' => 1,
                        'entity_types' => array(
                            '\\HBDemo\\Commenting\\Comment\\Model\\Aggregate\\Reference\\TopicType',
                        ),
                    )
                ),
                new \Trellis\Runtime\Attribute\EntityReferenceList\EntityReferenceListAttribute(
                    ...
                    array(
                        ...
                        'max_count' => 1,
                        'entity_types' => array(
                            '\\HBDemo\\Commenting\\Comment\\Model\\Aggregate\\Reference\\OwnerType',
                        ),
                    )
                ),
            ],
    ...
    {
        return '\\HBDemo\\Commenting\\Comment\\Model\\Aggregate\\Comment';
    }
}
