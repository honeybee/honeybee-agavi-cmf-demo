...
namespace HBDemo\Commenting\Topic\Projection\EventHandler;
...
use HBDemo\Commenting\Topic\Model\Task\ProceedTopicWorkflow\ProceedTopicWorkflowCommand;
use HBDemo\Commenting\Account\Model\Task\ProceedAccountWorkflow\AccountWorkflowProceededEvent;

class TopicProjectionUpdater extends RelationProjectionUpdater
{
    ...
    public function handleEvent(EventInterface $event)
    {
        ...
        if ($event instanceof AccountWorkflowProceededEvent
            ...
            foreach ($affected_entities as $affected_entity) {
                $command = new ProceedTopicWorkflowCommand(
                    [
