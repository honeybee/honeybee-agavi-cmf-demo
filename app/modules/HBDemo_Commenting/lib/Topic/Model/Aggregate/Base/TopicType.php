...
namespace HBDemo\Commenting\Topic\Model\Aggregate\Base;

use Trellis\Common\Options;
use Workflux\StateMachine\StateMachineInterface;
use HBDemo\Commenting\Topic\Model\Aggregate\Base;
use Honeybee\Model\Aggregate\AggregateRootType;

/**
 * Serves as the base class to the 'Topic' type skeleton.
 */
abstract class TopicType extends AggregateRootType
{
    /**
            ...
            [
                ...
                new \Trellis\Runtime\Attribute\EntityReferenceList\EntityReferenceListAttribute(
                    ...
                    array(
                        ...
                        'max_count' => 1,
                        'entity_types' => array(
                            '\\HBDemo\\Commenting\\Topic\\Model\\Aggregate\\Reference\\AccountType',
                        ),
                    )
                ),
            ],
    ...
    {
        return '\\HBDemo\\Commenting\\Topic\\Model\\Aggregate\\Topic';
    }
}
